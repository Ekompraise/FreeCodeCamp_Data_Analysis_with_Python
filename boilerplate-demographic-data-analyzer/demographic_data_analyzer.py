...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = round(len(min_hours_workers[min_hours_workers["salary"] == ">50K"]) / len(min_hours_workers) * 100, 1)

    # What country has the highest percentage of people that earn >50K?
    highest_earning_country = df[df["salary"] == ">50K"]["native-country"].value_counts().div(df[~(df["salary"] == ">50K")]["native-country"].value_counts()).idxmax()
